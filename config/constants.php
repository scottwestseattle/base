...
define('COOKIE_WEEK', 1440*7);      // Minutes per week: 60 * 24 * 7 << PREFERRED SETTING
define('COOKIE_YEAR', 1440*365);    // Minutes per year: 60 * 24 * 365 << WARNING: FILLS UP SERVER WITH FILES
