@extends('layouts.app')
@section('title', __('ui.Publish') . ' ' . trans_choice('view.Visitor', 1))
@section('menu-submenu')@component('visitors.menu-submenu', ['record' => $record])@endcomponent @endsection
@section('content')
<div class="container page-normal">

	<h1>{{__('ui.Publish')}} {{trans_choice('view.Visitor', 1)}}</h1>

	<form method="POST" action="/visitors/publishupdate/{{$record->id}}">
