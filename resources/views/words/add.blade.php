@extends('layouts.app')
@section('title', __('ui.Add') . ' ' . trans_choice('view.Word', 1))
@section('menu-submenu')@component('words.menu-submenu', ['prefix' => 'words'])@endcomponent @endsection
@section('content')
<div class="">
	<h1>{{__('ui.Add')}} {{trans_choice('view.Word', 1)}}</h1>
