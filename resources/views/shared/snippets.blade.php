...
@if (isset($options['records']) && count($options['records']) > 0)
    <h3 class="mt-2"><span class="float-left mr-2">@LANG('proj.Practice Text')</span>
         ...
         <span class="ml-2" style="font-size:.5em; vertical-align:middle;"><a href="/snippets/review">@LANG('proj.Flashcards')</a></span>
         <span class="ml-2" style="font-size:.5em; vertical-align:middle;"><a href="/snippets/review/20">@LANG('proj.Flashcards') (20)</a></span>
    </span></h3>
