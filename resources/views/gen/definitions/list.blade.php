...
<div class="page-nav-buttons">
    ...
    @if (isset($tag))
        ...
        <a class="btn btn-primary btn-sm btn-nav-top" role="button" href="{{route('definitions.favoritesReview', ['locale' => $locale])}}?tagId={{$tag->id}}&action=read&order={{$order}}&count={{DEFAULT_LIST_LIMIT}}&start=0">
