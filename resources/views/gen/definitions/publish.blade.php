@extends('layouts.app')
@section('title', __('ui.Publish') . ' ' . trans_choice('view.Definition', 1))
@section('menu-submenu')@component('gen.definitions.menu-submenu', ['record' => $record])@endcomponent @endsection
@section('content')
<div class="container page-normal">

	<h1>{{__('ui.Publish')}} {{trans_choice('view.Definition', 1)}}</h1>

	<form method="POST" action="/definitions/publishupdate/{{$record->id}}">
