    ...
    <div class="mb-3 mr-0">
        <div class="card-body drop-box-ghost">
            ...
            <p class="card-text">
                ...
                <a class="btn btn-primary btn-xs" role="button" href="{{route('definitions.favoritesReview', ['locale' => $locale])}}?action=read&count={{50/*DEFAULT_BIG_NUMBER*/}}&start=0&tagId={{$record->id}}&order={{$order}}">
